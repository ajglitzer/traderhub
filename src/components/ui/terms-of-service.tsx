...
export const TOS_SECTIONS: { title: string; body: string }[] = [
  ...
  { title: "3. Beta Software", body: "TraderHub is in active beta. Bugs, glitches, data-sync issues, and unexpected downtime are likely, and features may change or break without notice. Don't rely on TraderHub as your sole record of your trading activity — keep your own backups (e.g. broker statements or CSV exports) of anything important." },
  { title: "4. Not Financial Advice", body: "Nothing in TraderHub — journal analytics, AI-generated recaps or analysis, simulator results, community posts, or shared trades from other users — is financial, investment, tax, or legal advice. You are solely responsible for your own trading and investment decisions." },
  { title: "5. Your Account", body: "You're responsible for keeping your login credentials secure and for all activity under your account. Provide accurate information when you sign up. You must be at least 18 years old to use TraderHub." },
  { title: "6. Subscriptions & Billing", body: "TraderHub Pro is a paid subscription (monthly or annual) billed through Stripe. Subscriptions renew automatically until canceled. You can cancel anytime from Settings — your Pro access continues until the end of the billing period you already paid for. Except where required by law, payments are non-refundable." },
  { title: "7. Community Features & Acceptable Use", body: "If you use friending, messaging, or other community features, you agree to TraderHub's Community Guidelines (available in Settings). We may suspend or ban accounts that violate them, harass other users, or misuse the service." },
  { title: "8. Your Content", body: "You keep ownership of the trade data, notes, and messages you create. By sharing content with other users (trade cards, messages, your public profile) you're allowing TraderHub to display that content to the people you shared it with, or publicly, if you choose to make it public." },
  { title: "9. Service \"As Is\"", body: "TraderHub is provided \"as is\" without warranties of any kind. As beta software, we don't guarantee the app will be error-free, uninterrupted, or that any analytics, AI output, or market data will be accurate. Use it at your own risk." },
  { title: "10. Limitation of Liability", body: "To the fullest extent permitted by law, TraderHub and its operators aren't liable for any trading losses, lost profits, or indirect damages arising from your use of the app." },
  { title: "11. Termination", body: "You can stop using TraderHub and delete your account anytime from Settings. We may suspend or terminate accounts that violate these Terms or the Community Guidelines." },
  { title: "12. Changes", body: "We may update these Terms as the product changes. Continuing to use TraderHub after an update means you accept the revised Terms." },
];
